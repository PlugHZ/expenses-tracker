        ...
        <div className="w-full bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
            ...
            <div className="grid grid-cols-12 gap-4 px-6 py-3 border-b border-zinc-800 bg-zinc-800/50">
                ...
                <button
                    ...
                    className="col-span-3 flex items-center gap-1 text-xs font-medium text-zinc-500 uppercase tracking-wider hover:text-zinc-300"
                >
                ...
                <button
                    ...
                    className="col-span-2 flex items-center gap-1 text-xs font-medium text-zinc-500 uppercase tracking-wider hover:text-zinc-300"
                >
                    วันที่ <SortIcon col="date" />
                </button>
                <button
                    onClick={() => handleSort('amount')}
                    className="col-span-2 flex items-center justify-end gap-1 text-xs font-medium text-zinc-500 uppercase tracking-wider hover:text-zinc-300"
                >
